    ...
    >
      ...
      <div class="flex flex-col flex-1 h-full overflow-hidden">
        ...
        <main class="flex-1 max-h-full p-5 overflow-hidden overflow-y-scroll" id="mainContainer">
          ...
          <div class="flipCardsMain">
                  <div class="flipCardContainer">
                    <div class="Box">
                      <div class="FlipBox">
                        <div class="Front">
                          <img src="assets/images/undraw_process_re_gws7.svg">
                          <h1>View Startup Listings</h1>
                        </div>
                        <div class="Back">
                          <div>
                          <h3>View Startup Listings</h3>
                          <p>
                            Access our portfolio of startups looking to disrupt and innovate.
                          </p>
                          <a href="viewStartups.php">Learn More</a>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="Box">
                      <div class="FlipBox">
                        <div class="Front">
                          <img src="assets/images/undraw_invest_re_8jl5.svg">
                        ...
                        <div class="Back">
                          ...
                          <a href="comingSoon.html">Learn More</a>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="Box">
                      <div class="FlipBox">
                        <div class="Front">
                          <img src="assets/images/undraw_verified_re_4io7.svg">
                        ...
                        <div class="Back">
                          ...
                          <p>
                            Verify your account to get access to all the features
                          </p>
                          <a href="verify.php">Learn More</a>
                          </div>
                        </div>
                      </div>
                    </div>
