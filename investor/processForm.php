    ...
    if (isset($name)) {
        if(move_uploaded_file($_FILES['profileImage']['tmp_name'], $target)){
                ...
                if(mysqli_query($conn, $sql)){
                    ...
                    // $msg4 = "Image Uploaded and Saved to Database";
                    // $css_class4 = "alert--success";
                ...
                // $msg4 = "Database Error: Failed to save user";
                // $css_class4 = "alert--danger";
        ...
        if(mysqli_query($conn, $sql)){
            echo "
                        ...
                        ";
            // $msg4 = "Information Saved Successfully";
            // $css_class4 = "alert--success";
            $_SESSION['username'] = $userName;
            $_SESSION['email'] = $userEmail;
            $_SESSION['location'] = $userLocation;
