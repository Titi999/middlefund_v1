...
<html lang="en">
  ...
  <body>
   ...
   <div style="margin-top:10px; margin-right:20px"><h2 style="font-size:30px; font-weight:bold; color:white;">Upload Documents</h2>
       <h4>We need to confirm you are behind your account, so please complete this mandatory step to continue.</h4>
       <h4 style="margin-top:1px;">We require both sides of your ID</h4>
       <h5 style="margin-top:10px;margin-bottom:15px;">Type of ID</h5>
       <input id="myradio" type="radio" name="passport"><label >Passport</label>
       <input id="myradio" type="radio" name="passport"><label >ID Cards</label>
       <input id="myradio" type="radio" name="passport"><label >Drivers License</label>

       <div class="image-upload">
           <label for="myfile">
           <img class="myImg" src="" alt="">
           <p class="hide"><span style="font-size: 100px; margin-left: 30%; margin-top:15%"  class="material-icons-outlined cloud " id="cloud">  cloud_upload</span><br>
           <h3 style="margin-left:90px">Drop file or click to browse</h3></p> </label>
   ...
   <div class="vl"></div>
   <div style="margin-top:10px;"><h2 style="font-size:30px;font-weight:bold;color:white;">Proof of Residence</h2>
       <h4>Proof of address document can be one of the following: Bank/Credit Card statement or Utility bill- within the last 6 months</h4>
       <input style="margin-top:70px" id="myradio"type="radio" name="utility"><label >Utility Bill</label>
       <input id="myradio"type="radio" name="utility"><label >Bank/Credit Card statement</label>

       <div class="image-upload">
           <label for="myfile">
           <img class="myImg" src="" alt="">
           <p><span style="font-size: 100px; margin-left: 30%; margin-top:15%"  class="material-icons-outlined cloud " id="cloud">  cloud_upload</span><br>
           <h3 style="margin-left:90px">Drop file or click to browse</h3>
        </p> </label>
           <input id="myfile" type="file"style="display: none;"/>
       </div>
</div>
...
<input type="submit"  id="mySubmit"value="Submit">
    ...
    <script src="assets/js/smnxzsa./criptMit.js"></script>
    <script>
      const setup = () => {
        return {
          loading: true,
