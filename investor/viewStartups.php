...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="assets/css/viewStartups.css"/>
    ...
    >
      ...
      <div class="flex flex-col flex-1 h-full overflow-hidden">
        ...
        <main class="flex-1 max-h-full p-5 overflow-hidden overflow-y-scroll" id="mainContainer">
          ...
          <h3 style="color:#A49370; text-align:center;">Invest in the next generation of founders & startups</h3><br>
        ...
        <div class="flipCardsMain">
                  ...
                  <?php
                    ...
                    $stmt = $conn -> prepare("SELECT * FROM startup WHERE status = 'verified'");
                    $stmt ->execute();
                    $result =$stmt ->get_result();
                        ?>
            <div class="flipCardContainer" id="card-data">
              <?php 
            ...
            <div class="text">
                ...
                <img class="startupLogo" src="../startup/startupLogo/<?php echo $row['logo']; ?>" alt="">
                </div>
            ...
            <a class="viewMore" href="viewMore.php?ID=<?php echo $startupID; ?>">View More</a>
            <!-- <div class="links">
