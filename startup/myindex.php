    ...
    >
      ...
      <div class="flex flex-col flex-1 h-full overflow-hidden">
        ...
        <main class="flex-1 max-h-full p-5 overflow-hidden overflow-y-scroll" id="mainContainer">
          <!-- Main content header -->
          <h1>Welcome to The Start Up Portal</h1>
          <div class="flipCardsMain">
                  <div class="flipCardContainer">
                    <div class="Box">
                      <div class="FlipBox">
                        <div class="Front">
                          <img src="assets/images/pitch.svg">
                          <h1>Submit Pitch</h1>
                        </div>
                        <div class="Back">
                          <div>
                          <h3>Submit Pitch</h3>
                          <p>
                            Tell us about your startup and how much you are looking to raise. 
                          </p>
                          <a href="submitPitch.php">Learn More</a>
                          </div>
                        </div>
                      </div>
                    </div>
                    <div class="Box">
                      <div class="FlipBox">
                        <div class="Front">
                          <img src="assets/images/investors.svg">
                          <h1>MiddleFund Platinum</h1>
                        </div>
                        <div class="Back">
                          <div>
                          <h3>MiddleFund Platinum</h3>
                          <p>
